<div>
  ...
  border-width: 5px;">
   ...
   Tên tour: <b> {{$tour->t_title}} </b><br>
    ...
    Đường dẫn tour: <a href="{{ url('tour/' . $bookTour->b_tour_id . '/' . Str::slug($tour->t_title) . '.html') }}" style="color:blue;">
    Xem chi tiết tour </a>
 ...
 <b style="color:red">Nếu có thắc mắc, quý khách vui lòng liên hệ trungherok@gmail.com</b><br>
</div>
