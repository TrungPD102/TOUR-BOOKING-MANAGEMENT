...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vnpay/style.css') }}">
...
<div class="container">
    <div class="header clearfix">
        <h3 class="text-muted">THANH TOÁN HÓA ĐƠN VN PAY</h3>
    </div>
    <h3>Tạo mới đơn hàng</h3>
    <div class="table-responsive">
        <form action="{{ route('post.payment') }}" id="create_form" method="post">
            @csrf
            ...
            <button type="submit" class="btn btn-success" id="btnPopup">Xác nhận thanh toán</button>
            <button type="button" class="btn btn-success" onclick="history.back()">Quay trở lại</button>
        </form>
    </div>
    <p>
        &nbsp;
